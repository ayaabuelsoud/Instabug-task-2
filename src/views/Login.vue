    ...
    <div class="row">
      ...
      <div class="slider">
        <div class="slide active">
          <img src="@/assets/img/Product-overview.svg" />
          <p>Accelerate Your Entire Mobile Team Workflow</p>
        </div>

        <div class="slide">
          <img src="@/assets/img/Products-bug-reporting.svg" />
          <p>The most comprehensive bug reporting tool for mobile apps</p>
        </div>

        <div class="slide">
          <img src="@/assets/img/Products-crash-reporting.svg" />
            ...
            <div class="row">
              <div class="trusted-companies">
                <div class="company-item">
                  <!-- <img src="./img/companies/lyft.png" width="100%"> -->

                  <svg
                    viewBox="0 0 39 28"
                    class="lyft"
                    id="shape-lyft-full-logo"
                  >
                    <path
                ...
                <div class="company-item">
                  <!-- <img src="./img/companies/buzzfeed-logo.png" width="100%"> -->

                  <svg
                    viewBox="0 0 79 14"
                    class="buzzfeed"
                    id="shape-buzzfeed-full-logo"
                  >
                    <path
                ...
                <div class="company-item">
                  <!-- <img src="./img/companies/asana-1.png"> -->
                ...
                <div class="company-item">
                  <!-- <img src="./img/companies/oneplus.png"> -->
                ...
                <div class="company-item">
                  <!-- <img src="./img/companies/houseparty.png"> -->

                  <svg id="shape-house-party-logo" class="houseparty">
                    <path
                      fill-rule="evenodd"
...
export default {
  ...
  watch: {
    ...
    password: function (password) {
      ...
      if (
        !/(?=.*\d)(?=.*[A-Z])/.test(password) ||
        (emailName.length && password.includes(emailName))
      ) {
        this.notes.password =
